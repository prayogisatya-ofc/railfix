        ...
        <div class="row mb-3 align-items-center pt-2">
            ...
            <div class="col-md-8">
                <div class="float-start float-md-end">
                    ...
                    <button type="submit" form="form-update" class="btn btn-primary">Update</button>
                </div>
            </div>
        </div>
                ...
                <form action="{{ route('inventories.update', $inventory->id) }}" method="post" id="form-update">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <select name="location_id" class="form-control  @error('location_id') is-invalid @enderror">
                                ...
                                @foreach ($locations as $location)
                                    <option value="{{ $location->id }}" {{ $inventory->location_id == $location->id ? 'selected' : '' }}>{{ $location->name }}</option>
                                @endforeach
                            </select>
                            @error('location_id')
                                <small class="text-danger mt-1" role="alert">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="date" class="form-control  @error('date_in') is-invalid @enderror" name="date_in" value="{{ $inventory->date_in->format('Y-m-d') ?? old('date_in') }}">
                            @error('date_in')
                                <small class="text-danger mt-1" role="alert">
                                    {{ $message }}
                                </small>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="date" class="form-control  @error('date_out') is-invalid @enderror" name="date_out" value="{{ $inventory->date_out ? $inventory->date_out->format('Y-m-d') : '' ?? old('date_out') }}">
                            @error('date_out')
                                <small class="text-danger mt-1" role="alert">
                                    {{ $message }}
                                </small>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control  @error('pic') is-invalid @enderror" placeholder="Ex: Mas Bowo" name="pic" value="{{ $inventory->pic ?? old('pic') }}">
                            @error('pic')
                                <small class="text-danger mt-1" role="alert">
                                    {{ $message }}
                                </small>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control  @error('phone') is-invalid @enderror" placeholder="Ex: 08123456789" name="phone" value="{{ $inventory->phone ?? old('phone') }}">
                            @error('phone')
                                <small class="text-danger mt-1" role="alert">
                                    {{ $message }}
                                </small>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="status" class="form-control  @error('status') is-invalid @enderror">
                                ...
                                @foreach ($status as $item)
                                    <option value="{{ $item['value'] }}" {{ $inventory->status == $item['value'] ? 'selected' : '' }}>{{ $item['text'] }}</option>
                                @endforeach
                            </select>
                            @error('status')
                                <small class="text-danger mt-1" role="alert">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control  @error('description') is-invalid @enderror" placeholder="Masukkan Keterangan" name="description" rows="4">{{ $inventory->description ?? old('description') }}</textarea>
                        @error('description')
                            <small class="text-danger mt-1" role="alert">
                                {{ $message }}
                            </small>
