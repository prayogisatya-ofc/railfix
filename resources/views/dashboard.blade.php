...
<div class="pc-content">
    ...
    <div class="row">
        ...
        <div class="card shadow-sm rounded-3" style="height: 100px;">
                ...
                <ul class="nav nav-pills justify-content-end mb-0" id="chart-tab-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="chart-tab-profile-tab" data-bs-toggle="pill"
                            ...
                            aria-controls="chart-tab-profile" aria-selected="false">Bulan ini</button>
                    </li>
                </ul>
            </div>
            <div class="card">
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body pt-0">
                                    ...
                                    @forelse ($detailBarangMasukHariIni as $item)
                                        <tr>
                                            <td class="text-center">
                                                {{ ($detailBarangMasukHariIni->currentPage() - 1) * $detailBarangMasukHariIni->perPage() + $loop->iteration }}
                                            </td>
                                            <td>{{ $item->code }}</td>
                                            <td>{{ $item->name }}</td>
                        ...
                        <div class="mt-3">{{ $detailBarangMasukHariIni->links() }}</div>
                    </div>
                </div>
            </div>
        </div>
